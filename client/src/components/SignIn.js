...
const SignIn = (props) => {
    ...
    return ( 
        <form className="form-signin" onSubmit={handleSubmit}>
            ...
            <input type="text" id="inputEmail" name='email' onChange={ e => setEmail(e.target.value) } className="form-control" placeholder="Email address" autoFocus />
            ...
            <input type="password" id="inputPassword" name='password' onChange={ e => setPassword(e.target.value) } className="form-control" placeholder="Password" />
